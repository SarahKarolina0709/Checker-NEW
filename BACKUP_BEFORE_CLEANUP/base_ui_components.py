...
from typing import Callable, Dict, Any, List, Optional # Added List and Optional
import os
...
class BaseUIComponents:
    ...
    @staticmethod
    def create_card_title(parent_card: ctk.CTkFrame, title: str, font_alias: str = "h3"):
        """Adds a standard title to a card frame using pack for layout consistency."""
    ...
    @staticmethod
    def create_textbox_with_tab(tabview, tab_name: str, height: int = 200) -> ctk.CTkTextbox:
    ...
    @staticmethod
    def create_results_tabview(parent) -> tuple[ctk.CTkTabview, Dict[str, ctk.CTkTextbox]]:
    ...
    @staticmethod
    def create_file_selector_button(parent, text: str, command: Callable, 
    ...
    @staticmethod
    def create_main_button(parent, text: str, command: Callable, 
    ...
    @staticmethod
    def create_sub_button(parent, text: str, command: Callable, 
                          state: str = "normal", image: Optional[ctk.CTkImage] = None) -> ctk.CTkButton:
    ...
    @staticmethod
    def create_icon_button(parent, icon_path: str, command: Callable, 
    ...
    @staticmethod
    def create_status_bar(parent) -> tuple[ctk.CTkLabel, ctk.CTkProgressBar]:
...
class BaseWorkflowMixin:
    ...
    def setup_workflow(self, app, kunden_manager, project_data):
        self.app = app
