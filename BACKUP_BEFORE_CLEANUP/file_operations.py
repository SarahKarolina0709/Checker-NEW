...
if OCR_ENABLED:
    try:
        ...
        if POPPLER_CONFIG and POPPLER_CONFIG.is_configured:
            ...
            print("WARNUNG: Poppler nicht gefunden - PDF-Verarbeitung eingeschränkt.")
            PDF2IMAGE_ENABLED = False
...
try:
    ...
    PROJECT_DATA_DIR_FO = os.path.abspath(os.path.dirname(__file__))
    print("Warning (file_operations): project_data_manager.DATA_FILE not found, using script directory for last_inputs.json")
